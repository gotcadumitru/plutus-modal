...
export default {
  ...
  // cacheDirectory: "/private/var/folders/b9/zv9xpck95572ytgf4x31qjtw0000gn/T/jest_dx",
  ...
  //   '!src/shared/lib/utils/testUtils.tsx',
  //   '!src/app/types/axios.d.ts',
  ...
  moduleNameMapper: {
    ...
    '^.+\\.svg$': path.resolve(__dirname, 'jestSvgEmptyComponent.tsx'),
    '^.+\\.webp': path.resolve(__dirname, 'jestImgEmptyComponent.ts'),
  },
  ...
  // testPathIgnorePatterns: ['/node_modules/', '<rootDir>/config/jest/jestImgEmptyComponent.ts'],
